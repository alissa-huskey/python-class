...
DRAGONS = [
    ...
    },
    {
        ...
        "message": (
            ...
            "singes your hair, costing you {health} in health."
        ),
    },
    {
        "mood": "lonely",
        ...
        "message": (
            ...
            "you George... costing you {health} in health."
        )
    },
]
...
ITEMS = {
    ...
    "dragon": {
        ...
        "description": (
            f"A colossal dragon with heads of {', '.join(COLORS[0:-1])}, "
            f"and {COLORS[2]}."
        ),
    },
}
...
def do_consume(action, args):
    ...
    if health < 0:
        write(f"You lost {abs(difference)} point(s).")
    elif health > 0:
        write(f"You gained {difference} point(s).")
