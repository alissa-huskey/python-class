...
def test_do_pet_cranky_dragon(capsys):
    ...
    adventure.MOODS = [{
        "mood": "cranky",
        "damage": (-10, -10),
        "message": "pushes you away causing you {damage} damage",
    }]
    ...
    # THEN: A debug message should print
    assert "You picked the cranky red dragon." in output
...
def test_do_pet_lonely_dragon(capsys):
    ...
    adventure.MOODS = [{
        ...
        "damage": (-10, -10),
        "treasure": (20, 20),
        "message": "throws {gems} gems at you causing you {damage} damage",
    }]
